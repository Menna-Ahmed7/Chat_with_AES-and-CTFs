...
from utilties import read_from_file,generate_public_key,gamal_digital_signature_for_DH_public_key,verify_signatures,sha1,modinv,random_less_q,random_coprime_less_than,mod_pow
import socket
import threading
#--------reading q and alpha-----------
